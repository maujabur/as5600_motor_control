...
<main>
  ...
  <form id="config">
    ...
    <div class="save-wrap"><button class="save" type="submit">APLICAR PARÂMETROS</button><div class="message" id="message">Configuração persistente</div><a class="settings-link" href="/settings">AJUSTES AVANÇADOS</a></div>
  </form>
</main>
<script>
