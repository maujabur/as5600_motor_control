...
class AngleSensorDriversContractTest(unittest.TestCase):
    def test_shared_interface_and_concrete_drivers_exist(self):
        interface = (ROOT / "lib/hardware/AngleSensor.h").read_text(encoding="utf-8")
        as5600 = (ROOT / "lib/hardware/As5600Sensor.h").read_text(encoding="utf-8")
        mt6701 = (ROOT / "lib/hardware/Mt6701Sensor.h").read_text(encoding="utf-8")
    ...
    def test_mt6701_decodes_fourteen_bit_angle(self):
        implementation = (ROOT / "lib/hardware/Mt6701Sensor.cpp").read_text(encoding="utf-8")
        header = (ROOT / "lib/hardware/Mt6701Sensor.h").read_text(encoding="utf-8")
